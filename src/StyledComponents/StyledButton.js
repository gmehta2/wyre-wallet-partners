...
const useStyles = makeStyles(theme => ({
    primary: {
        backgroundImage: 'radial-gradient(0% 100%, rgba(226,33,21,0.89) 23%, rgba(197,22,22,0.90) 23%, rgba(161,18,18,0.92) 23%, rgba(131,15,15,0.93) 23%, rgba(70,8,8,0.96) 23%, rgba(217,99,72,0.88) 23%, rgba(203,93,68,0.89) 28%, rgba(189,86,63,0.89) 33%, rgba(173,79,58,0.90) 38%, rgba(143,66,48,0.92) 49%, rgba(101,46,34,0.94) 64%, rgba(76,35,25,0.96) 73%, rgba(44,20,15,0.98) 84%, #000000 100%)',
